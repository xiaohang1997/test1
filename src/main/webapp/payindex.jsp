			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dd id="btn-dd">
						...
						<span id="spanTime" style="color: #ff0000">180</span>
						秒后订单将失效 请及时支付
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "${course.name}";
		document.getElementById("WIDtotal_amount").value ="${course.price}";
		document.getElementById("WIDbody").value ="${course.introduce}";
	}
	GetDateNow();
...
<script type="text/javascript">
	...
	window.onload = function(){
		...
		var location="<%=request.getContextPath() %>/orderIndex.jsp";  //这里设置跳转到失效界面
		...
		function show(){
			...
			//将不断变化的秒数显示在页面上
			document.getElementById('spanTime').innerHTML = seconds;
			seconds--;
		}
	};
</script>
